...
OUTPUT_DB = BASE_DIR / "kp_index_recent.db"
TABLE_NAME = "kp_index_recent"


def fetch_recent_kp_index() -> Path:
    ...
    df = download_kp_index(start, end)
    ...
    print(f"[OK] Stored {len(df):,} Kp index rows from last 24h to {OUTPUT_DB}")
    return OUTPUT_DB


if __name__ == "__main__":
    fetch_recent_kp_index()
