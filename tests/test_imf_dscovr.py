...
from data_sources.imf_dscovr import IMFDSCOVRDataSource
...
def run_case(description, days):
    ...
    ds = IMFDSCOVRDataSource(days=days)
...
def main():
    run_case("DSCOVR sample (post-2015)", (date(2025, 12, 1), date(2025, 12, 3)))
