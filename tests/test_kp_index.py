...
from data_sources.kp_index.kp_index_data_source import KpIndexDataSource


def run_case(description, days):
    print("\n--------------------------------------------------")
    print(f"KP TEST: {description}")
    print("--------------------------------------------------")

    ds = KpIndexDataSource(days=days)
