...
MODEL_PATH = OUT_DIR / "stage1_xgb_model.joblib"
FEATURES_PATH = OUT_DIR / "stage1_xgb_features.joblib"
...
# ------------------------------------------------------------------
# Feature engineering (AUTHORITATIVE VERSION)
# ------------------------------------------------------------------
...
def main() -> None:
    ...
    print(f"Stage-1 XGB (12h lead, p ≥ {PROB_THRESHOLD}):")
