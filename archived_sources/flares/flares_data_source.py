...
from archived_sources.flares.flares_download import (
    DATASET_ARCHIVE,
    DATASET_REALTIME,
    GOES_ARCHIVE_RANGES,
...
from archived_sources.flares.flares_ingest import ingest_flares
from archived_sources.flares.flares_plot import plot_flares
